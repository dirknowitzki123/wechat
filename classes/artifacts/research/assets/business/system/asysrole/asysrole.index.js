...
function Global() {
	...
	that.layout = function() {
		...
		config.cols = cols = [];
		cols[ cols.length ] = { title: "角色编号", name: "roleCode", width: "150px", lockWidth: true };
		cols[ cols.length ] = { title: "角色名称", name: "roleName", width: "200px", lockWidth: true };
		cols[ cols.length ] = { title: "启用", name: "isUse", width: "60px", lockWidth: true,align:'center', renderer: function( val, item, rowIndex ) {
