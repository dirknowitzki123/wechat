...
<script type="text/javascript">
	App( "business/system/asyscode/aSysCode.typeForm", {} );
</script>
</head>
<body>
	<div class="container-fluid">
		<form class="">
			...
			<div class="row">
				<input type="text" class="input" name="typeName" options='{txtLabel: "类型名称"}'/>
				<input type="text" class="input" name="typeCode" options='{txtLabel: "类型编码"}'/>
