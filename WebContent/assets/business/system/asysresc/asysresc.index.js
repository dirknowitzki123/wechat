...
function Global() {
	...
	that.layout = function() {
		...
		config.cols = cols = [];
		cols[ cols.length ] = { title: "资源编号", name: "roleCode", width: "180px", lockWidth: true };
		cols[ cols.length ] = { title: "资源名称", name: "roleName", width: "180px", lockWidth: true };
		cols[ cols.length ] = { title: "启用状态", name: "isUse", width: "180px", lockWidth: true, renderer: function( val, item, rowIndex ) {
			return base.code.getText( "stat", val );
		} };
		cols[ cols.length ] = { title: "备注", name: "remark", };
		that.vars.gridVar = that.selector.find( "#rescGrid" ).grid( config );//renderer
	};
